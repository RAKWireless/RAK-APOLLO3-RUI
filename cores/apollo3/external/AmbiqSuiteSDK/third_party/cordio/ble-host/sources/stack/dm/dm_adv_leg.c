# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c" 2
...
# 31 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c" 2
...
# 32 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c" 2
...
# 33 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c" 2
...
# 84 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
static void dmAdvConfig(uint8_t advType, uint8_t peerAddrType, uint8_t *pPeerAddr)
{

  HciLeSetAdvParamCmd(dmAdvCb.intervalMin[0],
                      dmAdvCb.intervalMax[0],
                      advType,
                      DmLlAddrType(dmCb.advAddrType),
                      peerAddrType,
                      pPeerAddr,
                      dmAdvCb.channelMap[0],
                      dmCb.advFiltPolicy[0]);


  dmLegAdvCb.advType = advType;
}
# 109 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
void dmAdvActConfig(dmAdvMsg_t *pMsg)
{
  ;

  if (dmAdvCb.advState[0] == DM_ADV_STATE_IDLE)
  {

    if ((dmAdvCb.advType[0] == 1) ||
        (dmAdvCb.advType[0] == 4))
    {
      ;
      return;
...
# 139 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
void dmAdvActSetData(dmAdvMsg_t *pMsg)
{
  ;
...
# 168 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
void dmAdvActStart(dmAdvMsg_t *pMsg)
{
  ;
   ...
   if (dmAdvCb.advState[0] == DM_ADV_STATE_IDLE)
  {
    ...
    dmAdvCb.advState[0] = DM_ADV_STATE_STARTING;
    dmAdvCb.advDuration[0] = pMsg->apiStart.duration[0];
    HciLeSetAdvEnableCmd(1);
  }
}
# 198 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
void dmAdvActStop(dmAdvMsg_t *pMsg)
{
  ;

  if (dmAdvCb.advState[0] == DM_ADV_STATE_ADVERTISING)
  {
    ...
    dmAdvCb.advState[0] = DM_ADV_STATE_STOPPING;
    HciLeSetAdvEnableCmd(0);
  }
}
# 227 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
void dmAdvActRemoveSet(dmAdvMsg_t *pMsg)
{

}
# 241 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
void dmAdvActClearSets(dmAdvMsg_t *pMsg)
{

}
# 255 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
void dmAdvActSetRandAddr(dmAdvMsg_t *pMsg)
{

}
# 269 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
void dmAdvActTimeout(dmAdvMsg_t *pMsg)
{
  ;
...
# 288 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
void dmAdvReset(void)
{
  wsfMsgHdr_t advStop;


  if ((dmAdvCb.advState[0] == DM_ADV_STATE_STOPPING) ||
      ((dmAdvCb.advState[0] == DM_ADV_STATE_ADVERTISING) &&
       (dmAdvCb.advType[0] != 1)))
  {
...
# 321 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
void dmAdvHciHandler(hciEvt_t *pEvent)
{
  if (pEvent->hdr.event == 53)
  {
    uint8_t cbackEvent = 0;

    ;

    switch (dmAdvCb.advState[0])
    {
    case DM_ADV_STATE_STARTING:
    case DM_ADV_STATE_STARTING_DIRECTED:
      if (pEvent->hdr.status == 0x00)
      {
        if (dmAdvCb.advState[0] == DM_ADV_STATE_STARTING)
        {

          if (dmAdvCb.advDuration[0] > 0)
          {
            dmAdvCb.advTimer.msg.event = DM_ADV_MSG_TIMEOUT;
            WsfTimerStartMs(&dmAdvCb.advTimer, dmAdvCb.advDuration[0]);
          }


          if (dmLegAdvCb.advType != 4)
          {
        ...
        dmAdvCb.advType[0] = dmLegAdvCb.advType;
        dmAdvCb.advState[0] = DM_ADV_STATE_ADVERTISING;
      }
      else
      {
        dmAdvCb.advState[0] = DM_ADV_STATE_IDLE;
      }
      break;
...
# 425 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
void dmAdvMsgHandler(wsfMsgHdr_t *pMsg)
{

  (*dmAdvAct[((pMsg->event) & 0x0F)])((dmAdvMsg_t *)pMsg);
}
# 443 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
void dmAdvStartDirected(uint8_t advType, uint16_t duration, uint8_t addrType, uint8_t *pAddr)
{
  ;
  ...
  if (dmAdvCb.advState[0] == DM_ADV_STATE_IDLE)
  {
    ...
    dmAdvCb.advState[0] = (advType == 1) ?
                                              DM_ADV_STATE_STARTING_DIRECTED : DM_ADV_STATE_STARTING;

    dmAdvCb.advDuration[0] = duration;
    BdaCpy(dmAdvCb.peerAddr[0], pAddr);
    dmAdvCb.peerAddrType[0] = addrType;
  }
}
# 470 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
void dmAdvStopDirected(void)
{
  ;
  ...
  if ((dmAdvCb.advState[0] == DM_ADV_STATE_ADVERTISING) ||
      (dmAdvCb.advState[0] == DM_ADV_STATE_STARTING) ||
      (dmAdvCb.advState[0] == DM_ADV_STATE_STARTING_DIRECTED))
  {

    dmAdvCb.advState[0] = (dmLegAdvCb.advType == 1) ?
                                              DM_ADV_STATE_STOPPING_DIRECTED : DM_ADV_STATE_STOPPING;
    HciLeSetAdvEnableCmd(0);
  }
}
# 493 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
void dmAdvConnected(void)
{
  ;
...
# 513 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
void dmAdvConnectFailed(void)
{
  ;
...
# 533 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
void DmAdvInit(void)
{
  WsfTaskLock();
  ...
  dmDevCb.advSetRandAddrCback = 
# 544 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c" 3 4
                               ((void *)0)
# 544 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
                                   ;
...
# 559 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_adv_leg.c"
bool_t DmAdvModeLeg(void)
{
