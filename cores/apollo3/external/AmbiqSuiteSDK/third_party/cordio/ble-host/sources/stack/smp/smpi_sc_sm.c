# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpi_sc_sm.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpi_sc_sm.c"
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpi_sc_sm.c"
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpi_sc_sm.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpi_sc_sm.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpi_sc_sm.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpi_sc_sm.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpi_sc_sm.c" 2
...
enum
{
  SMPI_SC_ACT_NONE,
  SMPI_SC_ACT_CLEANUP,
  SMPI_SC_ACT_PAIRING_FAILED,
  SMPI_SC_ACT_PAIRING_CANCEL,
  SMPI_SC_ACT_PAIR_CNF_CALC_1,
  SMPI_SC_ACT_PAIR_CNF_CALC_2,
  SMPI_SC_ACT_SEND_PAIR_CNF,
  SMPI_SC_ACT_PAIR_CNF_VER_CALC_1,
  SMPI_SC_ACT_PAIR_CNF_VER_CALC_2,
  SMPI_SC_ACT_MAX_ATTEMPTS,
  SMPI_SC_ACT_ATTEMPT_RCVD,
  SMPI_SC_ACT_CHECK_ATTEMPTS,
  SMPI_SC_ACT_NOTIFY_DM_ATTEMPTS,
  SMPI_SC_ACT_NOTIFY_DM_RSP_TO,
  SMPI_SC_ACT_PAIRING_CMPL,
  SMPI_SC_ACT_PAIR_REQ,
  SMPI_SC_ACT_CHECK_SECURITY_REQ,
  SMPI_SC_ACT_PROC_SECURITY_REQ,
  SMPI_SC_ACT_PROC_PAIR_RSP,
  SMPI_SC_ACT_PROC_PAIR_CNF,
  SMPI_SC_ACT_CNF_VERIFY,
  SMPI_SC_ACT_STK_ENCRYPT,
  SMPI_SC_ACT_SETUP_KEY_DIST,
  SMPI_SC_ACT_RCV_KEY,
  SMPI_SC_ACT_SEND_KEY,

  SMPI_SC_ACT_SEND_PUB_KEY,
  SMPI_SC_ACT_SC_AUTH_SELECT,

  SMPI_SC_ACT_JWNC_SETUP,
  SMPI_SC_ACT_JWNC_SEND_RAND,
  SMPI_SC_ACT_JWNC_CALC_F4,
  SMPI_SC_ACT_JWNC_CALC_G2,
  SMPI_SC_ACT_JWNC_DISPLAY,

  SMPI_SC_ACT_PK_SETUP,
  SMPI_SC_ACT_PK_KEYPRESS,
  SMPI_SC_ACT_PK_SEND_KEYPRESS,
  SMPI_SC_ACT_PK_CALC_CA,
  SMPI_SC_ACT_PK_CALC_CB,
  SMPI_SC_ACT_PK_SEND_CNF,
  SMPI_SC_ACT_PK_SEND_RAND,
  SMPI_SC_ACT_PK_CHECK,

  SMPI_SC_ACT_OOB_CALC_CB,
  SMPI_SC_ACT_OOB_SEND_RAND,
  SMPI_SC_ACT_OOB_PROC_RAND,

  SMPI_SC_ACT_CALC_DHKEY,
  SMPI_SC_ACT_CALC_F5_TKEY,
  SMPI_SC_ACT_CALC_F5_MACKEY,
  SMPI_SC_ACT_CALC_F5_LTK,
  SMPI_SC_ACT_CALC_F6_EA,
  SMPI_SC_ACT_CALC_F6_EB,
  SMPI_SC_ACT_SEND_DH_CHECK,
  SMPI_SC_ACT_VERIFY_DH_CHECK,
};
...
static const smpTblEntry_t smpiScStateTblCommon[5] =
{
...
# 577 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpi_sc_sm.c"
void SmpiScInit(void)
{
...
# 595 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpi_sc_sm.c"
uint8_t *smpiStateStr(uint8_t state)
{
  switch(state)
  {
