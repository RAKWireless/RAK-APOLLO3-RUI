# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
# 23 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
...
# 24 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c" 2
...
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c" 2
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c" 2
...
void HciVendorSpecificCmd(uint16_t opcode, uint8_t len, uint8_t *pData);
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c" 2
...
# 31 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c" 2
# 45 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
void HciLeSetConnCteRxParamsCmd(uint16_t connHandle, uint8_t samplingEnable, uint8_t slotDurations,
                                uint8_t switchPatternLen, uint8_t *pAntennaIDs)
{
  uint8_t *pBuf;
  ...
  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x54)),
                          (5 + (switchPatternLen)))) != 
# 52 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c" 3 4
                                                                                  ((void *)0)
# 52 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
                                                                                      )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(connHandle); *(p)++ = (uint8_t)((connHandle) >> 8);};
    {*(p)++ = (uint8_t)(samplingEnable);};
    {*(p)++ = (uint8_t)(slotDurations);};
    {*(p)++ = (uint8_t)(switchPatternLen);};
    memcpy(p, pAntennaIDs, switchPatternLen);
    hciCmdSend(pBuf);
  }
}
# 76 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
void HciLeSetConnCteTxParamsCmd(uint16_t connHandle, uint8_t cteTypeBits, uint8_t switchPatternLen,
                                uint8_t *pAntennaIDs)
{
  uint8_t *pBuf;
  ...
  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x55)),
                          (4 + (switchPatternLen)))) != 
# 83 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c" 3 4
                                                                                  ((void *)0)
# 83 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
                                                                                      )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(connHandle); *(p)++ = (uint8_t)((connHandle) >> 8);};
    {*(p)++ = (uint8_t)(cteTypeBits);};
    {*(p)++ = (uint8_t)(switchPatternLen);};
    memcpy(p, pAntennaIDs, switchPatternLen);
    hciCmdSend(pBuf);
  }
}
# 107 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
void HciLeConnCteReqEnableCmd(uint16_t connHandle, uint8_t enable, uint16_t cteReqInt,
                              uint8_t reqCteLen, uint8_t reqCteType)
{
  uint8_t *pBuf;
  ...
  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x56)),
                          7)) != 
# 114 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c" 3 4
                                                             ((void *)0)
# 114 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
                                                                 )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(connHandle); *(p)++ = (uint8_t)((connHandle) >> 8);};
    {*(p)++ = (uint8_t)(enable);};
    {*(p)++ = (uint8_t)(cteReqInt); *(p)++ = (uint8_t)((cteReqInt) >> 8);};
    {*(p)++ = (uint8_t)(reqCteLen);};
    {*(p)++ = (uint8_t)(reqCteType);};
    hciCmdSend(pBuf);
  }
}
# 136 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
void HciLeConnCteRspEnableCmd(uint16_t connHandle, uint8_t enable)
{
  uint8_t *pBuf;
  uint8_t *p;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x57)),
                          3)) != 
# 142 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c" 3 4
                                                             ((void *)0)
# 142 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
                                                                 )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(connHandle); *(p)++ = (uint8_t)((connHandle) >> 8);};
...
# 158 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
void HciLeReadAntennaInfoCmd(void)
{
  uint8_t *pBuf;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x58)), 0)) != 
# 162 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c" 3 4
                                                                                            ((void *)0)
# 162 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
                                                                                                )
  {
    hciCmdSend(pBuf);
  }
}
# 181 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
                                ...
                                uint8_t *pAntennaIDs)
{
  ...
  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x51)),
                          (5 + (switchPatternLen)))) != 
# 188 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c" 3 4
                                                                                     ((void *)0)
# 188 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
                                                                                         )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(advHandle);};
...
# 213 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
void HciLeConnectionlessCteTxEnableCmd(uint8_t advHandle, bool_t enable)
{
  uint8_t *pBuf;
  uint8_t *p;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x52)),
                          2)) != 
# 219 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c" 3 4
                                                                   ((void *)0)
# 219 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
                                                                       )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(advHandle);};
...
# 243 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
void HciLeSetConlessIQSampleEnCmd(uint16_t syncHandle, uint8_t samplingEnable, uint8_t slotDurations,
                                uint8_t maxSampleCte,uint8_t switchPatternLen, uint8_t *pAntennaIDs)
{
  uint8_t *pBuf;
  ...
  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x53)),
                          (6 + (switchPatternLen)))) != 
# 250 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c" 3 4
                                                                                    ((void *)0)
# 250 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_cte.c"
                                                                                        )
  {
    p = pBuf + 3;
