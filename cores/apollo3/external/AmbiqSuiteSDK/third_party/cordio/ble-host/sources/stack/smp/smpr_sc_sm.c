# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpr_sc_sm.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpr_sc_sm.c"
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpr_sc_sm.c"
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpr_sc_sm.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpr_sc_sm.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpr_sc_sm.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpr_sc_sm.c" 2
...
# 31 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_sc_main.h" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpr_sc_sm.c" 2
...
enum
{
  SMPR_SC_ACT_NONE,
  SMPR_SC_ACT_CLEANUP,
  SMPR_SC_ACT_PAIRING_FAILED,
  SMPR_SC_ACT_PAIRING_CANCEL,
  SMPR_SC_ACT_SEND_PUB_KEY,
  SMPR_SC_ACT_STORE_LEGACY_PIN,
  SMPR_SC_ACT_STORE_LESC_PIN,

  SMPR_SC_ACT_PAIR_CNF_CALC_1,
  SMPR_SC_ACT_PAIR_CNF_CALC_2,
  SMPR_SC_ACT_SEND_PAIR_CNF,
  SMPR_SC_ACT_PAIR_CNF_VER_CALC_1,
  SMPR_SC_ACT_PAIR_CNF_VER_CALC_2,
  SMPR_SC_ACT_MAX_ATTEMPTS,
  SMPR_SC_ACT_PAIRING_CMPL,
  SMPR_SC_ACT_CHECK_ATTEMPTS,
  SMPR_SC_ACT_NOTIFY_DM_ATTEMPTS,
  SMPR_SC_ACT_NOTIFY_DM_RSP_TO,
  SMPR_SC_ACT_ATTEMPT_RCVD,

  SMPR_SC_ACT_SEND_SECURITY_REQ,
  SMPR_SC_ACT_PROC_PAIR_REQ,
  SMPR_SC_ACT_SEND_PAIR_RSP,
  SMPR_SC_ACT_PROC_PAIR_CNF,

  SMPR_SC_ACT_JWNC_SETUP,
  SMPR_SC_ACT_JWNC_SEND_CNF,
  SMPR_SC_ACT_JWNC_CALC_G2,
  SMPR_SC_ACT_JWNC_DISPLAY,

  SMPR_SC_ACT_PK_SETUP,
  SMPR_SC_ACT_PK_KEYPRESS,
  SMPR_SC_ACT_PK_SEND_KEYPRESS,
  SMPR_SC_ACT_PK_STORE_CNF,
  SMPR_SC_ACT_PK_STORE_CNF_CALC_CB,
  SMPR_SC_ACT_PK_STORE_PIN_CALC_CB,
  SMPR_SC_ACT_PK_CALC_CB,
  SMPR_SC_ACT_PK_SEND_CNF,
  SMPR_SC_ACT_PK_CALC_CA,
  SMPR_SC_ACT_PK_SEND_RAND,

  SMPR_SC_ACT_OOB_SETUP,
  SMPR_SC_ACT_OOB_CALC_CA,
  SMPR_SC_ACT_OOB_SEND_RAND,

  SMPR_SC_ACT_STORE_DH_CHECK,
  SMPR_SC_ACT_WAIT_DH_CHECK,
  SMPR_SC_ACT_CALC_DHKEY,
  SMPR_SC_ACT_CALC_F5_TKEY,
  SMPR_SC_ACT_CALC_F5_MACKEY,
  SMPR_SC_ACT_CALC_F5_LTK,
  SMPR_SC_ACT_CALC_F6_EA,
  SMPR_SC_ACT_CALC_F6_EB,
  SMPR_SC_ACT_SEND_DH_CHECK,

  SMPR_SC_ACT_PROC_PAIR_CNF_CALC_1,
  SMPR_SC_ACT_CNF_VERIFY,
  SMPR_SC_ACT_SEND_PAIR_RANDOM,
  SMPR_SC_ACT_SETUP_KEY_DIST,
  SMPR_SC_ACT_RCV_KEY,
  SMPR_SC_ACT_SEND_KEY
};
...
static const smpTblEntry_t smprScStateTblCommon[5] =
{
...
# 616 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpr_sc_sm.c"
void SmprScInit(void)
{
...
# 634 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smpr_sc_sm.c"
uint8_t *smprStateStr(uint8_t state)
{
  switch(state)
  {
