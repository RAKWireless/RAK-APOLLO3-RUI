# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c" 2
...
# 31 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c" 2
...
# 32 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c" 2
...
# 33 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c" 2
...
# 34 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c" 2
...
# 72 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
static attsIndCcb_t *attsIndCcbByConnId(dmConnId_t connId)
{
  ...
  else
  {
    ;
    return 
# 81 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c" 3 4
          ((void *)0)
# 81 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
              ;
  }
}
# 97 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
static bool_t attsPendIndNtfHandle(attsIndCcb_t *pCcb, attsPktParam_t *pPkt)
{
  ...
  opcode = *(((uint8_t *) pPkt) + (4 + 4));


  if (opcode == 0x1D)
  {

    return (pCcb->pendIndHandle == 0x0000) ? 0 : 1;
  }
  ...
  for (i = 0; i < 1; i++)
  {
    ...
    if (pCcb->pendNtfHandle[i] != 0x0000)
    {
  ...
  return (pendNtfs < 1) ? 0 : 1;
}
# 147 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
...
# 174 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
...
# 190 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
static void attsIndNtfCallback(dmConnId_t connId, attsIndCcb_t *pCcb, uint8_t status)
{
  uint8_t i;


  if (pCcb->pendIndHandle != 0x0000)
  {

    attsExecCallback(connId, pCcb->pendIndHandle, status);
    pCcb->pendIndHandle = 0x0000;
  }
  ...
  for (i = 0; i < 1; i++)
  {
    if (pCcb->pendNtfHandle[i] != 0x0000)
    {
      ...
      pCcb->pendNtfHandle[i] = 0x0000;
    }
  }
}
# 225 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
static void attsSetupMsg(attsIndCcb_t *pCcb, dmConnId_t connId, attsPktParam_t *pPkt)
{
  ...
  else if (!(pCcb->pMainCcb->control & (1<<1)))
  {
    attsExecCallback(connId, handle, 0x00);
  }
...
# 268 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
static void attsIndConnCback(attCcb_t *pCcb, dmEvt_t *pDmEvt)
{
  ...
  else if (pDmEvt->hdr.event == DM_CONN_CLOSE_IND)
  {
    ...
    if (pIndCcb->outIndHandle != 0x0000)
    {

      WsfTimerStop(&pIndCcb->outIndTimer);
      pIndCcb->outIndHandle = 0x0000;
    }
...
# 316 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
static void attsIndMsgCback(attsApiMsg_t *pMsg)
{
  attsIndCcb_t *pCcb;


  if ((pCcb = attsIndCcbByConnId((dmConnId_t) pMsg->hdr.param)) == 
# 321 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c" 3 4
                                                                  ((void *)0)
# 321 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
                                                                      )
  {
  ...
  if (pMsg->hdr.event == ATTS_MSG_API_VALUE_IND_NTF)
  {
    ...
    if (attsPendIndNtfHandle(pCcb, pMsg->pPkt))
    {
      ...
      attsExecCallback((dmConnId_t) pMsg->hdr.param, pMsg->pPkt->handle, 0x72);
      WsfMsgFree(pMsg->pPkt);
    }
  ...
  else if (pMsg->hdr.event == ATTS_MSG_IND_TIMEOUT)
  {
    ...
    if (pCcb->outIndHandle != 0x0000)
    {

      pCcb->outIndHandle = 0x0000;


      attsExecCallback((dmConnId_t) pMsg->hdr.param, pCcb->pendIndHandle, 0x71);
      pCcb->pendIndHandle = 0x0000;
      pCcb->pMainCcb->control |= (1<<2);
    }
  }
}
# 375 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
static void attsIndCtrlCback(wsfMsgHdr_t *pMsg)
{
  attsIndCcb_t *pCcb;
  ...
  if ((pCcb = attsIndCcbByConnId((dmConnId_t) pMsg->param)) != 
# 382 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c" 3 4
                                                              ((void *)0)
# 382 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
                                                                  )
  {

    attsIndNtfCallback((dmConnId_t) pMsg->param, pCcb, 0x00);
  }
}
# 403 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
                                  ...
                                  uint8_t *pValue, uint8_t opcode, bool_t zeroCpy)
{
  ...
  if ((pCcb = attsIndCcbByConnId(connId)) != 
# 414 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c" 3 4
                                            ((void *)0)
# 414 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
                                                )
  {
    ...
    if (!transTimedOut)
    {
      ...
      if (attsCsfIsClientChangeAware(connId, handle))
      {
        ...
        if ((valueLen + 3) <= mtu)
        {
          ...
          if ((pMsg = WsfMsgAlloc(sizeof(attsApiMsg_t))) != 
# 446 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c" 3 4
                                                           ((void *)0)
# 446 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
                                                               )
          {
            ...
            if (zeroCpy)
            {
              ...
              pMsg->pPkt = (attsPktParam_t *)(pValue - (3 + (4 + 4)));
            }
            else
            {

              pMsg->pPkt = attMsgAlloc((3 + (4 + 4)) + valueLen);
            }

            if (pMsg->pPkt != 
# 463 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c" 3 4
                             ((void *)0)
# 463 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
                                 )
            {

              pMsg->pPkt->len = 3 + valueLen;
              pMsg->pPkt->handle = handle;


              p = (uint8_t *)pMsg->pPkt + (4 + 4);
              {*(p)++ = (uint8_t)(opcode);};
        ...
        else
        {
          ...
          attsExecCallback(connId, handle, 0x77);
        }
      }
    }
    else

    {
      ...
      attsExecCallback(connId, handle, 0x71);
    }
  }
...
# 525 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
void attsProcValueCnf(attCcb_t *pCcb, uint16_t len, uint8_t *pPacket)
{
  attsIndCcb_t *pIndCcb;


  if ((pIndCcb = attsIndCcbByConnId(pCcb->connId)) == 
# 530 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c" 3 4
                                                     ((void *)0)
# 530 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
                                                         )
  {
    return;
  }
  ...
  if (pIndCcb->outIndHandle != 0x0000)
  {
    ...
    if (!(pCcb->control & (1<<1)))
    {
      attsExecCallback(pCcb->connId, pIndCcb->pendIndHandle, 0x00);
      pIndCcb->pendIndHandle = 0x0000;
    }
  }
}
# 560 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
void AttsIndInit(void)
{
  uint8_t i;
  attsIndCcb_t *pCcb;
  ...
  for (i = 0, pCcb = attsIndCb.ccb; i < 3; i++, pCcb++)
  {
    ...
    pCcb->outIndTimer.msg.param = i + 1;
  }


  attsCb.pInd = &attsIndFcnIf;
}
# 592 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
void AttsHandleValueInd(dmConnId_t connId, uint16_t handle, uint16_t valueLen, uint8_t *pValue)
{
  attsHandleValueIndNtf(connId, handle, valueLen, pValue, 0x1D, 0);
}
# 609 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
void AttsHandleValueNtf(dmConnId_t connId, uint16_t handle, uint16_t valueLen, uint8_t *pValue)
{
  attsHandleValueIndNtf(connId, handle, valueLen, pValue, 0x1B, 0);
}
# 629 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
void AttsHandleValueIndZeroCpy(dmConnId_t connId, uint16_t handle, uint16_t valueLen,
                               uint8_t *pValue)
{
  attsHandleValueIndNtf(connId, handle, valueLen, pValue, 0x1D, 1);
}
# 650 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_ind.c"
void AttsHandleValueNtfZeroCpy(dmConnId_t connId, uint16_t handle, uint16_t valueLen,
                               uint8_t *pValue)
{
  attsHandleValueIndNtf(connId, handle, valueLen, pValue, 0x1B, 1);
}
