# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c" 2
...
# 31 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c" 2
...
# 32 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c" 2
...
#define SMP_DB_COMMON_REC 0
#define SMP_DB_FIRST_REC 1
...
typedef struct
{
  ...
  uint8_t addrType;
  uint8_t failCount;
  uint16_t attemptMult;
  uint32_t lockMs;
  uint32_t expDecrementMs;
  uint32_t failCountToMs;
} smpDbDevice_t;
...
{
  smpDbDevice_t db[3];
  wsfTimer_t serviceTimer;
} smpDbCb;
# 80 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
static void smpDbStartServiceTimer(void)
{
  if (smpDbCb.serviceTimer.isStarted == 0)
  {
    WsfTimerStartMs(&smpDbCb.serviceTimer, 1000);
  }
}
# 97 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
...
# 128 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
static smpDbDevice_t *smpDbAddDevice(uint8_t *pAddr, uint8_t addrType)
{
  smpDbDevice_t *pRec = &smpDbCb.db[1];
  uint8_t i;
  ...
  return 
# 148 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c" 3 4
        ((void *)0)
# 148 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
            ;
}
# 160 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
static smpDbDevice_t *smpDbGetRecord(dmConnId_t connId)
{
  ...
  if (pRec == 
# 180 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c" 3 4
             ((void *)0)
# 180 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
                 )
  {
    ;
...
# 198 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
void SmpDbInit(void)
{

  if (smpDbCb.serviceTimer.isStarted == 1)
  {
...
# 223 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
uint32_t SmpDbGetPairingDisabledTime(dmConnId_t connId)
{
...
# 243 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
void SmpDbSetFailureCount(dmConnId_t connId, uint8_t count)
{
  smpDbDevice_t *pRec = smpDbGetRecord(connId);
...
# 266 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
uint8_t SmpDbGetFailureCount(dmConnId_t connId)
{
  smpDbDevice_t *pRec = smpDbGetRecord(connId);
...
# 284 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
uint32_t SmpDbMaxAttemptReached(dmConnId_t connId)
{
  smpDbDevice_t *pRec = smpDbGetRecord(connId);
  uint16_t multiplier;
...
# 329 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
void SmpDbPairingFailed(dmConnId_t connId)
{
  smpDbDevice_t *pRec = smpDbGetRecord(connId);
...
# 346 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
void SmpDbService(void)
{
  uint8_t i;
  ...
  for (i = 0; i < 3; i++, pRec++)
  {
    if (smpDbRecordInUse(pRec))
    {
      ...
      do { pRec->expDecrementMs = pRec->expDecrementMs > 1000 ? pRec->expDecrementMs - 1000 : 0;} while (0);
      do { pRec->lockMs = pRec->lockMs > 1000 ? pRec->lockMs - 1000 : 0;} while (0);
      do { pRec->failCountToMs = pRec->failCountToMs > 1000 ? pRec->failCountToMs - 1000 : 0;} while (0);
...
# 395 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
...
# 417 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/smp/smp_db.c"
