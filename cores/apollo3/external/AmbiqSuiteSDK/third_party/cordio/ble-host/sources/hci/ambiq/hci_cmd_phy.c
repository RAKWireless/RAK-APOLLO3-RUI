# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_phy.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_phy.c"
# 23 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_phy.c"
...
# 24 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_phy.c" 2
...
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_phy.c" 2
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_phy.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_phy.c" 2
...
void HciVendorSpecificCmd(uint16_t opcode, uint8_t len, uint8_t *pData);
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_phy.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_phy.c" 2
# 37 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_phy.c"
void HciLeReadPhyCmd(uint16_t handle)
{
  uint8_t *pBuf;
  uint8_t *p;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x30)), 2)) != 0)
  {
    p = pBuf + 3;
...
# 57 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_phy.c"
void HciLeSetDefaultPhyCmd(uint8_t allPhys, uint8_t txPhys, uint8_t rxPhys)
{
  uint8_t *pBuf;
  uint8_t *p;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x31)), 3)) != 0)
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(allPhys);};
    {*(p)++ = (uint8_t)(txPhys);};
...
# 79 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_phy.c"
void HciLeSetPhyCmd(uint16_t handle, uint8_t allPhys, uint8_t txPhys, uint8_t rxPhys, uint16_t phyOptions)
{
  uint8_t *pBuf;
  uint8_t *p;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x32)), 7)) != 0)
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(handle); *(p)++ = (uint8_t)((handle) >> 8);};
    {*(p)++ = (uint8_t)(allPhys);};
    {*(p)++ = (uint8_t)(txPhys);};
    {*(p)++ = (uint8_t)(rxPhys);};
    {*(p)++ = (uint8_t)(phyOptions); *(p)++ = (uint8_t)((phyOptions) >> 8);};
    hciCmdSend(pBuf);
  }
}
