# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c" 2
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/include/att_uuid.h" 1
# 31 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c" 2
...
# 32 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c" 2
...
# 64 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
static bool_t attcUuidCmp(attcDiscChar_t *pChar, uint8_t *pUuid, uint8_t settings)
{

  if ((pChar->settings & 0x01) == settings)
  {

    return (memcmp(pChar->pUuid, pUuid, (settings == 0) ? 2 : 16) == 0);
  }

  else if ((settings == 0x01) && ((pChar->settings & 0x01) == 0))
  {
...
# 96 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
static uint8_t attcDiscVerify(attcDiscCb_t *pCb)
{
  ...
  for (i = 0, pChar = pCb->pCharList; i < pCb->charListLen; i++, pChar++)
  {
    ...
    if (((*pChar)->settings & 0x02) != 0)
    {

      if (pCb->pHdlList[i] == 0x0000)
      {
        return 0x76;
      }
    }
...
# 131 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
static uint8_t attcDiscDescriptors(dmConnId_t connId, attcDiscCb_t *pCb)
{
  attcDiscChar_t **pChar;
  uint16_t startHdl = 0x0000;
  uint16_t endHdl = 0x0000;
  ...
  while (pCb->charListIdx < pCb->charListLen)
  {
    ...
    if (((*pChar)->settings & 0x04) != 0)
    {
      ...
      pCb->pHdlList[pCb->charListIdx] = 0x0000;
  ...
  {
    AttcFindInfoReq(connId, startHdl, endHdl, 1);
    return 0x78;
  }
}
# 210 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
static void attcDiscProcDescPair(attcDiscCb_t *pCb, uint8_t settings, uint8_t *pPair)
{
  ...
  {{hdl = ((uint16_t)(pPair)[0] + ((uint16_t)(pPair)[1] << 8));}; pPair += 2;};


  pDesc = &pCb->pCharList[pCb->charListIdx];
  for (i = pCb->charListIdx;
       (i < pCb->charListLen) && (((*pDesc)->settings & 0x04) != 0);
       i++, pDesc++)
  {
...
# 253 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
static uint8_t attcDiscProcDesc(attcDiscCb_t *pCb, attEvt_t *pMsg)
{
  ...
  if (pMsg->hdr.status != 0x00 || pMsg->continuing == 0)
  {
...
# 337 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
static void attcDiscProcCharDecl(attcDiscCb_t *pCb, uint8_t settings, uint8_t *pDecl)
{
  ...
  {{declHdl = ((uint16_t)(pDecl)[0] + ((uint16_t)(pDecl)[1] << 8));}; pDecl += 2;};
  pDecl++;
  {{hdl = ((uint16_t)(pDecl)[0] + ((uint16_t)(pDecl)[1] << 8));}; pDecl += 2;};


  if (pCb->endHdlIdx != 0xFF)
  {
...
# 409 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
...
# 482 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
static uint8_t attcDiscConfigNext(dmConnId_t connId, attcDiscCb_t *pCb)
{
  ...
  while (pCb->charListIdx < pCb->cfgListLen)
  {
    ...
    if (pCb->pHdlList[pCfg->hdlIdx] != 0x0000)
    {
...
# 531 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
void AttcDiscService(dmConnId_t connId, attcDiscCb_t *pCb, uint8_t uuidLen, uint8_t *pUuid)
{
  AttcFindByTypeValueReq(connId, 0x0001, 0xFFFF, 0x2800,
                         uuidLen, pUuid, 0);
}
# 549 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
uint8_t AttcDiscServiceCmpl(attcDiscCb_t *pCb, attEvt_t *pMsg)
{
  uint8_t *p;
  ...
  p = pMsg->pValue;
  {{pCb->svcStartHdl = ((uint16_t)(p)[0] + ((uint16_t)(p)[1] << 8));}; p += 2;};
  {{pCb->svcEndHdl = ((uint16_t)(p)[0] + ((uint16_t)(p)[1] << 8));}; p += 2;};

  ;

  return 0x00;
}
# 592 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
void AttcDiscCharStart(dmConnId_t connId, attcDiscCb_t *pCb)
{
  ...
  AttcReadByTypeReq(connId, pCb->svcStartHdl, pCb->svcEndHdl, 2,
                    (uint8_t *) attChUuid, 1);
}
# 616 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
uint8_t AttcDiscCharCmpl(attcDiscCb_t *pCb, attEvt_t *pMsg)
{
  uint8_t status;
...
# 661 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
uint8_t AttcDiscConfigStart(dmConnId_t connId, attcDiscCb_t *pCb)
{
...
# 682 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
uint8_t AttcDiscConfigCmpl(dmConnId_t connId, attcDiscCb_t *pCb)
{
...
# 703 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/attc_disc.c"
uint8_t AttcDiscConfigResume(dmConnId_t connId, attcDiscCb_t *pCb)
{
  return attcDiscConfigNext(connId, pCb);
}
