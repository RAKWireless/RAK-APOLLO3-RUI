# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c" 2
...
void HciVendorSpecificCmd(uint16_t opcode, uint8_t len, uint8_t *pData);
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c" 2
...
# 31 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c" 2
...
# 32 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c" 2
...
# 33 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c" 2
...
# 34 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c" 2
...
# 35 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c" 2
...
# 36 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c" 2
...
static const uint16_t dmEvtCbackLen[] =
{
  ...
  sizeof(dmSecPairCmplIndEvt_t),
  sizeof(wsfMsgHdr_t),
  sizeof(dmSecEncryptIndEvt_t),
  sizeof(wsfMsgHdr_t),
  sizeof(dmSecAuthReqIndEvt_t),
  sizeof(dmSecKeyIndEvt_t),
  sizeof(hciLeLtkReqEvt_t),
  sizeof(dmSecPairIndEvt_t),
  sizeof(dmSecSlaveIndEvt_t),
  sizeof(dmSecOobCalcIndEvt_t),
  sizeof(secEccMsg_t),
  sizeof(dmSecCnfIndEvt_t),
  sizeof(dmSecKeypressIndEvt_t),
  sizeof(wsfMsgHdr_t),
  sizeof(dmPrivGenAddrIndEvt_t),
  ...
  sizeof(dmPerAdvSetStartEvt_t),
  sizeof(dmPerAdvSetStopEvt_t),
  ...
  sizeof(hciLeConlessIQReportEvt_t),
...
dmFcnIf_t *dmFcnIfTbl[14] =
{
  (dmFcnIf_t *) &dmFcnDefault,
  (dmFcnIf_t *) &dmFcnDefault,
  (dmFcnIf_t *) &dmFcnDefault,
  (dmFcnIf_t *) &dmFcnDefault,
  (dmFcnIf_t *) &dmFcnDefault,
...
dmCb_t dmCb;
# 238 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
static void dmHciEvtCback(hciEvt_t *pEvent)
{
  ;


  if (!dmCb.resetting || (pEvent->hdr.event == 0))
  {

    (*(dmFcnIfTbl[dmHciToIdTbl[pEvent->hdr.event]]->hciHandler))(pEvent);
  }
}
# 257 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
void dmEmptyReset(void)
{

}
# 271 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
void dmEmptyHandler(wsfMsgHdr_t *pMsg)
{
  return;
}
# 285 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
void dmDevPassHciEvtToConn(hciEvt_t *pEvent)
{

  (*(dmFcnIfTbl[3]->hciHandler))(pEvent);
}
# 300 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
void DmRegister(dmCback_t cback)
{
  dmCb.cback = cback;


  if (dmFcnIfTbl[8] != &dmFcnDefault)
  {

    if ((1 + 2*32) > (HciGetMaxRxAclLen() - 4))
    {
      dmEvt_t evt;
...
# 332 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
uint8_t *DmFindAdType(uint8_t adType, uint16_t dataLen, uint8_t *pData)
{
  ...
  while ((dataLen != 0) && (pData[0] != 0) && (pData[0] < dataLen))
  {
    ...
    dataLen = dataLen - pData[0] - 1;
    pData = pData + pData[0] + 1;
  }


  return 0;
}
# 364 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
...
# 386 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
void DmHandler(wsfEventMask_t event, wsfMsgHdr_t *pMsg)
{
  ...
  if (pMsg != 0)
  {
    ...
    if (!dmCb.resetting)
    {
      ...
      (*(dmFcnIfTbl[((pMsg->event) >> 4)]->msgHandler))(pMsg);
    }
  }
...
# 414 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
bool_t DmLlPrivEnabled(void)
{
  return dmCb.llPrivEnabled;
}
# 428 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
uint8_t DmLlAddrType(uint8_t addrType)
{
...
# 457 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
uint8_t DmHostAddrType(uint8_t addrType)
{
...
# 486 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
uint16_t DmSizeOfEvt(dmEvt_t *pDmEvt)
{
  uint16_t len;


  if ((pDmEvt->hdr.event >= 0x20) && (pDmEvt->hdr.event <= DM_VENDOR_SPEC_CMD_CMPL_IND))
  {
    len = dmEvtCbackLen[pDmEvt->hdr.event - 0x20];
  }
  else
  {
...
# 513 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
static uint8_t dmScanPhyToIdx(uint8_t numPhys, uint8_t scanPhy)
{
  ...
  if (numPhys == 2)
  {
    return (scanPhy == (1<<0)) ? 0 : 1;
  }


  return (scanPhy == (1<<0)) ? 0 : (scanPhy == (1<<1)) ? 1 : 2;
}
# 540 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
uint8_t DmScanPhyToIdx(uint8_t scanPhy)
{
  return dmScanPhyToIdx(2, scanPhy);
}
# 555 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
uint8_t dmInitPhyToIdx(uint8_t numPhys, uint8_t initPhy)
{
  ...
  if (numPhys == 2)
  {
    return (initPhy == (1<<0)) ? 0 : 1;
  }


  return (initPhy == (1<<0)) ? 0 : (initPhy == (1<<1)) ? 1 : 2;
}
# 582 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_main.c"
uint8_t DmInitPhyToIdx(uint8_t initPhy)
{
  return dmInitPhyToIdx(2, initPhy);
}
