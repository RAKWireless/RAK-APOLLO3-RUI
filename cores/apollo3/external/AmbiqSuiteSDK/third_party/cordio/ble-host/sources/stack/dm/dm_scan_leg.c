# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c"
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c"
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c" 2
...
# 31 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c" 2
...
# 32 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c" 2
...
# 63 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c"
void dmScanActStart(dmScanMsg_t *pMsg)
{
  uint8_t phyIdx = DmScanPhyToIdx((1<<0));
  ...
  if (dmScanCb.scanState == DM_SCAN_STATE_IDLE)
  {
    ...
    HciLeSetScanEnableCmd(1, pMsg->apiStart.filterDup);
  }
}
# 105 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c"
void dmScanActStop(dmScanMsg_t *pMsg)
{
...
# 124 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c"
void dmScanActTimeout(dmScanMsg_t *pMsg)
{
  dmScanActStop(pMsg);
}
# 138 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c"
static void dmScanActHciReport(hciEvt_t *pEvent)
{
  ...
  if (dmScanCb.scanState == DM_SCAN_STATE_SCANNING)
  {
    ...
    if (dmScanCb.discFilter != 0)
    {
      ...
      if (pEvent->leAdvReport.eventType == 4)
      {
      ...
      else
      {
        ...
        p = DmFindAdType(0x01, pEvent->leAdvReport.len, pEvent->leAdvReport.pData);
        if (p == 0)
        {
...
# 195 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c"
void dmScanReset(void)
{
...
# 229 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c"
void dmScanHciHandler(hciEvt_t *pEvent)
{
  if (pEvent->hdr.event == 6)
  {
    dmScanActHciReport(pEvent);
  }
  else if (pEvent->hdr.event == 52)
  {
...
# 300 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c"
void dmScanMsgHandler(wsfMsgHdr_t *pMsg)
{

  (*dmScanAct[((pMsg->event) & 0x0F)])((dmScanMsg_t *)pMsg);
}
# 313 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c"
void DmScanInit(void)
{
  WsfTaskLock();
...
# 333 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_leg.c"
bool_t DmScanModeLeg(void)
{
