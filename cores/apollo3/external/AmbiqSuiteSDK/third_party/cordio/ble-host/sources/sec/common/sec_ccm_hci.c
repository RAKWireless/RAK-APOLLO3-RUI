# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c" 2
...
# 31 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c" 2
...
# 32 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c" 2
...
# 33 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c" 2
...
# 34 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c" 2
...
# 36 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c" 2
...
# 37 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c" 2


#define SEC_CCM_CFG SEC_CCM_CFG_HCI
# 49 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
enum
{
...
# 75 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
...
# 97 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
...
# 114 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
static void secCcmGenX0(secQueueBuf_t *pBuf)
{
  secCcmSecCb_t *pCcm = (secCcmSecCb_t*) pBuf->pCb;


  pCcm->scratch[0] = (2 - 1) | (((pCcm->micLen - 2) / 2) << 3) | ((pCcm->clearLen > 0? 1:0) << 6);
  pCcm->scratch[16 - 2] = pCcm->textLen >> 8;
  pCcm->scratch[16 - 1] = pCcm->textLen & 0xFF;
...
# 142 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
static void secCcmGenXiHdr(secQueueBuf_t *pBuf, uint8_t *pPriorX)
{
  ...
  if (remaining >= 16 - offset)
  {
    memcpy(b_i + offset, pCcm->pClear + pCcm->position - 2, 16 - offset);
    pCcm->position += 16 - offset;
  ...
  else
  {
    ...
    memset(b_i + offset + remaining, 0, 16 - remaining - offset);
    pCcm->state = SEC_CCM_STATE_XI_MSG;
    pCcm->position = 0;
  }
...
# 201 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
static void secCcmGenXiMsg(secQueueBuf_t *pBuf, uint8_t *pPriorX)
{
  ...
  else
  {
    ...
    memset(b_i + remaining, 0, 16 - remaining);
    pCcm->state = SEC_CCM_STATE_S0;
  }
...
# 244 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
static void secCcmGenS0(secQueueBuf_t *pBuf, uint8_t *x_n)
{
  ...
  pCcm->scratch[0] = (2 - 1);
  pCcm->scratch[16 - 2] = pCcm->scratch[16 - 1] = 0;
...
# 273 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
...
# 304 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
static void secCcmMicComplete(secQueueBuf_t *pBuf, uint8_t *s_0)
{
  ...
  else
  {
    ...
    {
      pMsg->pText = 
# 332 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c" 3 4
                   ((void *)0)
# 332 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
                       ;
      pMsg->textLen = 0;
      pMsg->success = 0;
    }
...
# 353 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
static void secCcmGenSi(secQueueBuf_t *pBuf, uint8_t *pPriorS)
{
  ...
  len = pCcm->textLen - ((pCcm->counter - 1) * 16);
  len = len > 16? 16 : len;


  resultOffset = (pCcm->counter - 1) * 16 + pCcm->clearLen;

  secCcmCalcXor(pCcm->pWorking + resultOffset, pPriorS, (uint8_t) len);

  if (pCcm->counter * 16 >= pCcm->textLen)
  {
    if (pCcm->operation == 0)
    {
  ...
  else
  {
    ...
    pCcm->counter++;
    pCcm->scratch[16 - 2] = pCcm->counter >> 8;
    pCcm->scratch[16 - 1] = pCcm->counter & 0xFF;


    secCcmBlockEncrypt(pBuf, pCcm->scratch);
  }
}
# 412 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
...
# 461 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
bool_t SecCcmEnc(const uint8_t *pKey, uint8_t *pNonce, uint8_t *pPlainText, uint16_t textLen,
                 uint8_t *pClear, uint16_t clearLen, uint8_t micLen, uint8_t *pResult,
                 wsfHandlerId_t handlerId, uint16_t param, uint8_t event)
{
  ...
  if ((pBuf = WsfMsgAlloc(bufSize)) != 
# 470 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c" 3 4
                                      ((void *)0)
# 470 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
                                          )
  {
    ...
    memcpy(&pCcm->scratch[1], pNonce, (15-2));
...
# 529 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
bool_t SecCcmDec(const uint8_t *pKey, uint8_t *pNonce, uint8_t *pCypherText, uint16_t textLen,
                 uint8_t *pClear, uint16_t clearLen, uint8_t *pMic, uint8_t micLen,
                 uint8_t *pResult, wsfHandlerId_t handlerId, uint16_t param, uint8_t event)
{
  ...
  if ((pBuf = WsfMsgAlloc(bufSize)) != 
# 538 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c" 3 4
                                      ((void *)0)
# 538 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
                                          )
  {
    secCcmSecCb_t *pCcm = (secCcmSecCb_t *) (pBuf + 1);
...
# 590 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/sec/common/sec_ccm_hci.c"
void SecCcmInit(void)
{
