# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 2
...
# 31 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 2
...
# 32 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 2
...
# 33 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 2
...
# 34 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 2
...
# 35 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 2
...
# 60 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
static uint8_t attsExecPrepWrite(attCcb_t *pCcb, attsPrepWrite_t *pPrep)
{
  ...
  if ((pAttr = attsFindByHandle(pPrep->handle, &pGroup)) == 
# 70 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                                           ((void *)0)
# 70 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                                               )
  {
  ...
  else if (!(pAttr->permissions & 0x10))
  {
    err = 0x03;
  }

  else if ((pAttr->settings & 0x02) &&
           (pGroup->writeCback != 
# 82 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                 ((void *)0)
# 82 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                     ))
  {


    err = (*pGroup->writeCback)(pCcb->connId, pPrep->handle, 0x18,
                                pPrep->offset, pPrep->writeLen, p, pAttr);
  }

  else if ((pAttr->settings & 0x20) && (attsCb.cccCback != 
# 90 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                                                  ((void *)0)
# 90 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                                                      ))
  {
    err = (*attsCb.cccCback)(pCcb->connId, 9, pPrep->handle, p);
  }
  else
  {
...
# 122 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
void attsProcWrite(attCcb_t *pCcb, uint16_t len, uint8_t *pPacket)
{
  uint8_t *pBuf;
  uint8_t *p;
  ...
  pPacket += (4 + 4);
  {opcode = (uint8_t)(*(pPacket)++);};
  {{handle = ((uint16_t)(pPacket)[0] + ((uint16_t)(pPacket)[1] << 8));}; pPacket += 2;};
  writeLen = len - 3;


  if ((pAttr = attsFindByHandle(handle, &pGroup)) != 
# 140 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                                    ((void *)0)
# 140 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                                        )
  {

    if ((err = attsPermissions(pCcb->connId, 0x10,
                               handle, pAttr->permissions)) != 0x00)
    {

    }

    else if (((pAttr->settings & 0x08) == 0) &&
    ...
    else
    {
      ...
      if ((pAttr->settings & 0x02) &&
          (pGroup->writeCback != 
# 164 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                ((void *)0)
# 164 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                    ))
      {
...
# 170 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                                                      ((void *)0)
# 170 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                                                          ))
      {
        err = (*attsCb.cccCback)(pCcb->connId, 9, handle, pPacket);
      }
      else
      {
      ...
      if (err == 0x00 && opcode == 0x12)
      {
        if ((pBuf = attMsgAlloc((4 + 4) + 1)) != 
# 189 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                                                          ((void *)0)
# 189 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                                                              )
        {
          ...
          L2cDataReq(0x0004, pCcb->handle, 1, pBuf);
        }
      }
    }
  }
  ...
  if (err && (opcode == 0x12))
  {
    ...
    {
      attsErrRsp(pCcb->handle, 0x12, handle, err);
    }
  }
}
# 232 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
void attsProcPrepWriteReq(attCcb_t *pCcb, uint16_t len, uint8_t *pPacket)
{
  uint8_t *pBuf;
  uint8_t *p;
  ...
  if ((pAttr = attsFindByHandle(handle, &pGroup)) == 
# 251 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                                    ((void *)0)
# 251 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                                        )
  {
  ...
  else if ((err = attsPermissions(pCcb->connId, 0x10,
                               handle, pAttr->permissions)) != 0x00)
  {

  }

  else if ((offset != 0) && ((pAttr->settings & 0x10) == 0))
  {
    err = 0x0B;
  }
  ...
  else if ((pPrep = WsfBufAlloc(sizeof(attsPrepWrite_t) - 1 + writeLen)) == 
# 279 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                                                           ((void *)0)
# 279 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                                                               )
  {
    err = 0x11;
  }
          ...
          (pGroup->writeCback != 
# 284 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                ((void *)0)
# 284 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                    ))
  {
    err = (*pGroup->writeCback)(pCcb->connId, handle, 0x16, 0, writeLen,
                                pPacket, pAttr);
  }
  ...
  if (err == 0x00)
  {
    ...
    if ((pBuf = attMsgAlloc((4 + 4) + 5 + writeLen)) != 
# 300 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                                                                      ((void *)0)
# 300 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                                                                          )
    {
      ...
      {*(p)++ = (uint8_t)(offset); *(p)++ = (uint8_t)((offset) >> 8);};
      memcpy(p, pPacket, writeLen);

      L2cDataReq(0x0004, pCcb->handle, (5 + writeLen), pBuf);
    }
  }

  if (err)
  {
    attsErrRsp(pCcb->handle, 0x16, handle, err);
  }
}
# 330 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
void attsProcExecWriteReq(attCcb_t *pCcb, uint16_t len, uint8_t *pPacket)
{
  uint8_t *pBuf;
  uint8_t *p;
  ...
  else if (*pPacket == 0x01)
  {

    for (pPrep = pCcb->prepWriteQueue.pHead; pPrep != 
# 351 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                                     ((void *)0)
# 351 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                                         ; pPrep = pPrep->pNext)
    {

      if ((pAttr = attsFindByHandle(pPrep->handle, &pGroup)) != 
# 354 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                                               ((void *)0)
# 354 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                                                   )
      {
    ...
    if (err == 0x00)
    {
      ...
      while ((pPrep = WsfQueueDeq(&pCcb->prepWriteQueue)) != 
# 380 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                                            ((void *)0)
# 380 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                                                )
      {

        if ((err = attsExecPrepWrite(pCcb, pPrep)) != 0x00)
        {
  ...
  if (err)
  {
    attsErrRsp(pCcb->handle, 0x18, 0, err);
  }
  else
  {
    if ((pBuf = attMsgAlloc((4 + 4) + 1)) != 
# 407 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                                                           ((void *)0)
# 407 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                                                               )
    {
...
# 433 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
void AttsContinueWriteReq(dmConnId_t connId, uint16_t handle, uint8_t status)
{
  attCcb_t *pCcb;
  uint8_t *pBuf;
  ...
  if ((pCcb = attCcbByConnId(connId)) == 
# 440 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                        ((void *)0)
# 440 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                            )
  {
    return;
  }
  ...
  if (status)
  {
    attsErrRsp(pCcb->handle, 0x12, handle, status);
  }
  else
  {
    if ((pBuf = attMsgAlloc((4 + 4) + 1)) != 
# 454 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c" 3 4
                                                                      ((void *)0)
# 454 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/att/atts_write.c"
                                                                          )
    {
