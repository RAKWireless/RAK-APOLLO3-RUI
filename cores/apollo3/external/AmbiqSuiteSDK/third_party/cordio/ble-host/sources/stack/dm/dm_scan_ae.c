# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c"
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c"
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan.h" 2
...
# 31 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c" 2
...
# 32 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c" 2
...
# 33 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c" 2
...
#define DM_ADV_RPT_SCAN_RSP(evtType) ((((evtType) == HCI_ADV_RPT_LEG_CONN_UNDIRECT_SCAN_RSP) || ((evtType) == HCI_ADV_RPT_LEG_SCAN_UNDIRECT_SCAN_RSP)) || ((((evtType) & HCI_ADV_RPT_LEG_ADV_BIT) == 0) && ((evtType) & HCI_ADV_RPT_SCAN_RSP_BIT)))
...
# 77 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c"
void dmExtScanActStart(dmScanMsg_t *pMsg)
{
  uint8_t i;
  uint8_t idx;
  uint8_t phyIdx;
  hciExtScanParam_t scanParam[2];
  ...
  if (dmScanCb.scanState == DM_SCAN_STATE_IDLE)
  {
    ...
    if (pMsg->apiStart.mode == 1)
    {
      dmScanCb.discFilter = 0x01;
    }
    else if (pMsg->apiStart.mode == 2)
    {
      dmScanCb.discFilter = 0x01 | 0x02;
    }
    else
    {
    ...
    dmScanCb.filterNextScanRsp = 0;


    dmScanCb.scanState = DM_SCAN_STATE_STARTING;
    HciLeExtScanEnableCmd(1, pMsg->apiStart.filterDup, (pMsg->apiStart.duration / 10), pMsg->apiStart.period);
  }
}
# 136 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c"
void dmExtScanActStop(dmScanMsg_t *pMsg)
{
  if (dmScanCb.scanState == DM_SCAN_STATE_SCANNING)
  {
    ...
    HciLeExtScanEnableCmd(0, 0, 0, 0);
  }
}
# 155 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c"
void dmExtScanActTimeout(dmScanMsg_t *pMsg)
{

}
# 169 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c"
static void dmExtScanActHciReport(hciEvt_t *pEvent)
{
  uint8_t *p;
  static bool_t filtered = 0;
  static bool_t firstFrag = 1;
  ...
  if (dmScanCb.scanState == DM_SCAN_STATE_SCANNING)
  {
    ...
    if ((dmScanCb.discFilter != 0) && firstFrag)
    {
      ...
      if (((((pEvent->leExtAdvReport.eventType) == 0x1B) || ((pEvent->leExtAdvReport.eventType) == 0x1A)) || ((((pEvent->leExtAdvReport.eventType) & (1<<4)) == 0) && ((pEvent->leExtAdvReport.eventType) & (1<<3)))))
      {
      ...
      else
      {
        ...
        p = DmFindAdType(0x01, pEvent->leExtAdvReport.len, pEvent->leExtAdvReport.pData);
        if (p == 0)
        {

          filtered = 1;
          dmScanCb.filterNextScanRsp = 1;
        }

        else if ((p[2] & dmScanCb.discFilter) == 0)
        {
    ...
    if ((dmScanCb.discFilter != 0) &&
        ((((pEvent->leExtAdvReport.eventType) & (3<<5)) >> 5) != 0x01))
    {
...
# 238 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c"
void dmExtScanReset(void)
{
      ...
      (dmScanCb.scanState == DM_SCAN_STATE_SCANNING))
  {
    ...
    scanTimeout.hdr.event = 45;
    scanTimeout.hdr.status = 0x00;
...
# 267 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c"
void dmExtScanHciHandler(hciEvt_t *pEvent)
{
  ;

  if (pEvent->hdr.event == 44)
  {
    dmExtScanActHciReport(pEvent);
  }
  else if (pEvent->hdr.event == 45)
  {
  ...
  else if (pEvent->hdr.event == 54)
  {
    switch (dmScanCb.scanState)
    {
    case DM_SCAN_STATE_STARTING:
      pEvent->hdr.event = DM_EXT_SCAN_START_IND;
      dmScanCb.scanState = pEvent->hdr.status == 0x00? DM_SCAN_STATE_SCANNING : DM_SCAN_STATE_IDLE;
      break;

    case DM_SCAN_STATE_STOPPING:
      pEvent->hdr.event = DM_EXT_SCAN_STOP_IND;
      dmScanCb.scanState = pEvent->hdr.status == 0x00? DM_SCAN_STATE_IDLE : DM_SCAN_STATE_SCANNING;
      break;
...
# 325 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c"
void dmExtScanMsgHandler(wsfMsgHdr_t *pMsg)
{

  (*dmScanAct[((pMsg->event) & 0x0F)])((dmScanMsg_t *)pMsg);
}
# 338 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c"
void DmExtScanInit(void)
{
  WsfTaskLock();


  dmFcnIfTbl[2] = (dmFcnIf_t *) &dmScanFcnIf;
...
# 359 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/stack/dm/dm_scan_ae.c"
bool_t DmScanModeExt(void)
{
  return (dmFcnIfTbl[2] == (dmFcnIf_t *) &dmScanFcnIf) ? 1 : 0;
}
