# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
# 23 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
...
# 24 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 2
...
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 2
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 2
...
void HciVendorSpecificCmd(uint16_t opcode, uint8_t len, uint8_t *pData);
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 2
# 41 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeSetAdvSetRandAddrCmd(uint8_t advHandle, const uint8_t *pAddr)
{
  uint8_t *pBuf;
  uint8_t *p;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x35)), 7)) != 
# 46 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                                    ((void *)0)
# 46 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                        )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(advHandle);};
...
# 65 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeSetExtAdvParamCmd(uint8_t advHandle, hciExtAdvParam_t *pExtAdvParam)
{
  uint8_t *pBuf;
  uint8_t *p;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x36)), 25)) != 
# 70 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                            ((void *)0)
# 70 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(advHandle);};
    {*(p)++ = (uint8_t)(pExtAdvParam->advEventProp); *(p)++ = (uint8_t)((pExtAdvParam->advEventProp) >> 8);};
    {*(p)++ = (uint8_t)(pExtAdvParam->priAdvInterMin); *(p)++ = (uint8_t)((pExtAdvParam->priAdvInterMin) >> 8); *(p)++ = (uint8_t)((pExtAdvParam->priAdvInterMin) >> 16);};
    {*(p)++ = (uint8_t)(pExtAdvParam->priAdvInterMax); *(p)++ = (uint8_t)((pExtAdvParam->priAdvInterMax) >> 8); *(p)++ = (uint8_t)((pExtAdvParam->priAdvInterMax) >> 16);};
    {*(p)++ = (uint8_t)(pExtAdvParam->priAdvChanMap);};
    {*(p)++ = (uint8_t)(pExtAdvParam->ownAddrType);};
    {*(p)++ = (uint8_t)(pExtAdvParam->peerAddrType);};
    {BdaCpy(p, pExtAdvParam->pPeerAddr); p += 6;};
    {*(p)++ = (uint8_t)(pExtAdvParam->advFiltPolicy);};
    {*(p)++ = (uint8_t)(pExtAdvParam->advTxPwr);};
    {*(p)++ = (uint8_t)(pExtAdvParam->priAdvPhy);};
    {*(p)++ = (uint8_t)(pExtAdvParam->secAdvMaxSkip);};
    {*(p)++ = (uint8_t)(pExtAdvParam->secAdvPhy);};
    {*(p)++ = (uint8_t)(pExtAdvParam->advSetId);};
    {*(p)++ = (uint8_t)(pExtAdvParam->scanReqNotifEna);};
    hciCmdSend(pBuf);
  }
}
# 105 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeSetExtAdvDataCmd(uint8_t advHandle, uint8_t op, uint8_t fragPref, uint8_t len,
                           const uint8_t *pData)
{
  uint8_t *pBuf;
  ...
  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x37)), (4 + (len)))) != 
# 116 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                               ((void *)0)
# 116 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                   )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(advHandle);};
...
# 141 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeSetExtScanRespDataCmd(uint8_t advHandle, uint8_t op, uint8_t fragPref, uint8_t len,
                                const uint8_t *pData)
{
  uint8_t *pBuf;
  ...
  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x38)),
                          (4 + (len)))) != 
# 153 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                     ((void *)0)
# 153 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                         )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(advHandle);};
...
# 176 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeSetExtAdvEnableCmd(uint8_t enable, uint8_t numSets, hciExtAdvEnableParam_t *pEnableParam)
{
  uint8_t *pBuf;
  uint8_t *p;
  ...
  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x39)), (2 + (4 * (numSets))))) != 
# 182 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                                   ((void *)0)
# 182 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                       )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(enable);};
    ...
    for (i = 0; i < numSets; i++)
    {
      {*(p)++ = (uint8_t)(pEnableParam[i].advHandle);};
      {*(p)++ = (uint8_t)(pEnableParam[i].duration); *(p)++ = (uint8_t)((pEnableParam[i].duration) >> 8);};
      {*(p)++ = (uint8_t)(pEnableParam[i].maxEaEvents);};
    }

    hciCmdSend(pBuf);
  }
}
# 206 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeReadMaxAdvDataLen(void)
{
  uint8_t *pBuf;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x3A)), 0)) != 
# 210 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                                    ((void *)0)
# 210 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                        )
  {
    hciCmdSend(pBuf);
  }
}
# 223 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeReadNumSupAdvSets(void)
{
  uint8_t *pBuf;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x3B)), 0)) != 
# 227 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                                       ((void *)0)
# 227 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                           )
  {
    hciCmdSend(pBuf);
  }
}
# 242 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeRemoveAdvSet(uint8_t advHandle)
{
  uint8_t *pBuf;
  uint8_t *p;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x3C)), 1)) != 
# 247 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                      ((void *)0)
# 247 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                          )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(advHandle);};
...
# 262 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeClearAdvSets(void)
{
  uint8_t *pBuf;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x3D)), 0)) != 
# 266 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                      ((void *)0)
# 266 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                          )
  {
    hciCmdSend(pBuf);
  }
}
# 284 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeSetPerAdvParamCmd(uint8_t advHandle, uint16_t advIntervalMin, uint16_t advIntervalMax,
                            uint16_t advProps)
{
  uint8_t *pBuf;
  ...
  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x3E)), 7)) != 
# 290 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                            ((void *)0)
# 290 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(advHandle);};
    {*(p)++ = (uint8_t)(advIntervalMin); *(p)++ = (uint8_t)((advIntervalMin) >> 8);};
    {*(p)++ = (uint8_t)(advIntervalMax); *(p)++ = (uint8_t)((advIntervalMax) >> 8);};
    {*(p)++ = (uint8_t)(advProps); *(p)++ = (uint8_t)((advProps) >> 8);};
    hciCmdSend(pBuf);
  }
}
# 313 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeSetPerAdvDataCmd(uint8_t advHandle, uint8_t op, uint8_t len, const uint8_t *pData)
{
  uint8_t *pBuf;
  uint8_t *p;
  ...
  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x3F)), (3 + (len)))) != 
# 323 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                               ((void *)0)
# 323 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                   )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(advHandle);};
...
# 344 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeSetPerAdvEnableCmd(uint8_t enable, uint8_t advHandle)
{
  uint8_t *pBuf;
  uint8_t *p;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x40)), 2)) != 
# 349 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                              ((void *)0)
# 349 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                  )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(enable);};
...
# 370 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeSetExtScanParamCmd(uint8_t ownAddrType, uint8_t scanFiltPolicy, uint8_t scanPhys,
                             hciExtScanParam_t *pScanParam)
{
  uint8_t *pBuf;
  ...
  for (i = 0, numPhys = 0; (i < 8) && (numPhys <= 3); i++)
  {
    if (scanPhys & (1 << i))
    {
      numPhys++;
  ...
  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x41)), (3 + (5 * (numPhys))))) != 
# 387 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                                       ((void *)0)
# 387 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                           )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(ownAddrType);};
    {*(p)++ = (uint8_t)(scanFiltPolicy);};
    {*(p)++ = (uint8_t)(scanPhys);};

    for (i = 0; i < numPhys; i++)
    {
      {*(p)++ = (uint8_t)(pScanParam[i].scanType);};
      {*(p)++ = (uint8_t)(pScanParam[i].scanInterval); *(p)++ = (uint8_t)((pScanParam[i].scanInterval) >> 8);};
      {*(p)++ = (uint8_t)(pScanParam[i].scanWindow); *(p)++ = (uint8_t)((pScanParam[i].scanWindow) >> 8);}
    }

    hciCmdSend(pBuf);
  }
}
# 417 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeExtScanEnableCmd(uint8_t enable, uint8_t filterDup, uint16_t duration, uint16_t period)
{
  uint8_t *pBuf;
  uint8_t *p;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x42)), 6)) != 
# 422 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                                ((void *)0)
# 422 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                    )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(enable);};
    {*(p)++ = (uint8_t)(filterDup);};
    {*(p)++ = (uint8_t)(duration); *(p)++ = (uint8_t)((duration) >> 8);};
    {*(p)++ = (uint8_t)(period); *(p)++ = (uint8_t)((period) >> 8);};
    hciCmdSend(pBuf);
  }
}
# 444 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeExtCreateConnCmd(hciExtInitParam_t *pInitParam, hciExtInitScanParam_t *pScanParam,
                           hciConnSpec_t *pConnSpec)
{
  uint8_t *pBuf;
  ...
  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x43)), (10 + (16 * (numPhys))))) != 
# 461 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                                 ((void *)0)
# 461 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                     )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(pInitParam->filterPolicy);};
    {*(p)++ = (uint8_t)(pInitParam->ownAddrType);};
    {*(p)++ = (uint8_t)(pInitParam->peerAddrType);};
    {BdaCpy(p, pInitParam->pPeerAddr); p += 6;};
    {*(p)++ = (uint8_t)(pInitParam->initPhys);};

    for (i = 0; i < numPhys; i++)
    {
      {*(p)++ = (uint8_t)(pScanParam[i].scanInterval); *(p)++ = (uint8_t)((pScanParam[i].scanInterval) >> 8);};
      {*(p)++ = (uint8_t)(pScanParam[i].scanWindow); *(p)++ = (uint8_t)((pScanParam[i].scanWindow) >> 8);};
      {*(p)++ = (uint8_t)(pConnSpec[i].connIntervalMin); *(p)++ = (uint8_t)((pConnSpec[i].connIntervalMin) >> 8);};
      {*(p)++ = (uint8_t)(pConnSpec[i].connIntervalMax); *(p)++ = (uint8_t)((pConnSpec[i].connIntervalMax) >> 8);};
      {*(p)++ = (uint8_t)(pConnSpec[i].connLatency); *(p)++ = (uint8_t)((pConnSpec[i].connLatency) >> 8);};
      {*(p)++ = (uint8_t)(pConnSpec[i].supTimeout); *(p)++ = (uint8_t)((pConnSpec[i].supTimeout) >> 8);};
      {*(p)++ = (uint8_t)(pConnSpec[i].minCeLen); *(p)++ = (uint8_t)((pConnSpec[i].minCeLen) >> 8);};
      {*(p)++ = (uint8_t)(pConnSpec[i].maxCeLen); *(p)++ = (uint8_t)((pConnSpec[i].maxCeLen) >> 8);};
    }

    hciCmdSend(pBuf);
  }
}
# 502 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLePerAdvCreateSyncCmd(uint8_t options, uint8_t advSid, uint8_t advAddrType,
                              uint8_t *pAdvAddr, uint16_t skip, uint16_t syncTimeout, uint8_t unused)
{
  uint8_t *pBuf;
  ...
  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x44)), 14)) != 
# 508 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                                ((void *)0)
# 508 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                    )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(options);};
    {*(p)++ = (uint8_t)(advSid);};
    {*(p)++ = (uint8_t)(advAddrType);};
    {BdaCpy(p, pAdvAddr); p += 6;};
    {*(p)++ = (uint8_t)(skip); *(p)++ = (uint8_t)((skip) >> 8);};
    {*(p)++ = (uint8_t)(syncTimeout); *(p)++ = (uint8_t)((syncTimeout) >> 8);};
    {*(p)++ = (uint8_t)(unused);};
    hciCmdSend(pBuf);
  }
}
# 529 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLePerAdvCreateSyncCancelCmd(void)
{
  uint8_t *pBuf;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x45)), 0)) != 
# 533 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                                              ((void *)0)
# 533 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                                  )
  {
    hciCmdSend(pBuf);
  }
}
# 548 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLePerAdvTerminateSyncCmd(uint16_t syncHandle)
{
  uint8_t *pBuf;
  uint8_t *p;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x46)), 2)) != 
# 553 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                                      ((void *)0)
# 553 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                          )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(syncHandle); *(p)++ = (uint8_t)((syncHandle) >> 8);};
    hciCmdSend(pBuf);
  }
}
# 572 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeAddDeviceToPerAdvListCmd(uint8_t advAddrType, uint8_t *pAdvAddr, uint8_t advSid)
{
  uint8_t *pBuf;
  uint8_t *p;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x47)), 8)) != 
# 577 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                                  ((void *)0)
# 577 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                      )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(advAddrType);};
...
# 598 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeRemoveDeviceFromPerAdvListCmd(uint8_t advAddrType, uint8_t *pAdvAddr, uint8_t advSid)
{
  uint8_t *pBuf;
  uint8_t *p;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x48)), 8)) != 
# 603 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                                        ((void *)0)
# 603 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                            )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(advAddrType);};
...
# 620 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeClearPerAdvListCmd(void)
{
  uint8_t *pBuf;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x49)), 0)) != 
# 624 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                              ((void *)0)
# 624 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                  )
  {
    hciCmdSend(pBuf);
  }
}
# 637 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeReadPerAdvListSizeCmd(void)
{
  uint8_t *pBuf;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x4A)), 0)) != 
# 641 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                                      ((void *)0)
# 641 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                          )
  {
    hciCmdSend(pBuf);
  }
}
# 654 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeReadTxPower(void)
{
  uint8_t *pBuf;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x4B)), 0)) != 
# 658 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                    ((void *)0)
# 658 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                        )
  {
    hciCmdSend(pBuf);
  }
}
# 671 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeReadRfPathComp(void)
{
  uint8_t *pBuf;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x4C)), 0)) != 
# 675 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                            ((void *)0)
# 675 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                )
  {
    hciCmdSend(pBuf);
  }
}
# 691 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
void HciLeWriteRfPathComp(int16_t txPathComp, int16_t rxPathComp)
{
  uint8_t *pBuf;
  uint8_t *p;

  if ((pBuf = hciCmdAlloc((((0x08) << 10) + (0x4D)), 4)) != 
# 696 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c" 3 4
                                                                                              ((void *)0)
# 696 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-host/sources/hci/ambiq/hci_cmd_ae.c"
                                                                                                  )
  {
    p = pBuf + 3;
    {*(p)++ = (uint8_t)(txPathComp); *(p)++ = (uint8_t)((txPathComp) >> 8);};
    {*(p)++ = (uint8_t)(rxPathComp); *(p)++ = (uint8_t)((rxPathComp) >> 8);};
    hciCmdSend(pBuf);
  }
}
