# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/wsf/sources/port/freertos/wsf_queue.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/wsf/sources/port/freertos/wsf_queue.c"
# 23 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/wsf/sources/port/freertos/wsf_queue.c"
...
# 24 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/wsf/sources/port/freertos/wsf_queue.c" 2
...
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/wsf/sources/port/freertos/wsf_queue.c" 2
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/wsf/sources/port/freertos/wsf_queue.c" 2
...
void WsfCsExit(void);
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/wsf/sources/port/freertos/wsf_queue.c" 2
...
{
  struct wsfQueueElem_tag *pNext;
} wsfQueueElem_t;
# 57 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/wsf/sources/port/freertos/wsf_queue.c"
void WsfQueueEnq(wsfQueue_t *pQueue, void *pElem)
{
  ;
  ...
  {
    (((wsfQueueElem_t *)(pQueue->pTail))->pNext) = pElem;
    pQueue->pTail = pElem;
  }
...
# 98 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/wsf/sources/port/freertos/wsf_queue.c"
void *WsfQueueDeq(wsfQueue_t *pQueue)
{
  ...
  if (pElem != 0)
  {
    ...
    pQueue->pHead = (((wsfQueueElem_t *)(pElem))->pNext);
...
# 142 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/wsf/sources/port/freertos/wsf_queue.c"
void WsfQueuePush(wsfQueue_t *pQueue, void *pElem)
{
  ;
  ...
  (((wsfQueueElem_t *)(pElem))->pNext) = pQueue->pHead;
...
# 182 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/wsf/sources/port/freertos/wsf_queue.c"
void WsfQueueInsert(wsfQueue_t *pQueue, void *pElem, void *pPrev)
{
  ;
  ...
  if (pQueue->pHead == 0 || pPrev == pQueue->pTail)
  {
  ...
  else
  {
    ...
    (((wsfQueueElem_t *)(pElem))->pNext) = (((wsfQueueElem_t *)(pPrev))->pNext);
    (((wsfQueueElem_t *)(pPrev))->pNext) = pElem;
  }


  WsfCsExit();
}
# 229 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/wsf/sources/port/freertos/wsf_queue.c"
void WsfQueueRemove(wsfQueue_t *pQueue, void *pElem, void *pPrev)
{
  ;
  ...
  else if (pPrev)
  {
    ...
    (((wsfQueueElem_t *)(pPrev))->pNext) = (((wsfQueueElem_t *)(pElem))->pNext);
  }
...
# 274 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/wsf/sources/port/freertos/wsf_queue.c"
uint16_t WsfQueueCount(wsfQueue_t *pQueue)
{
  wsfQueueElem_t *pElem;
  uint16_t count = 0;
...
# 312 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/wsf/sources/port/freertos/wsf_queue.c"
bool_t WsfQueueEmpty(wsfQueue_t *pQueue)
{
  bool_t empty;
