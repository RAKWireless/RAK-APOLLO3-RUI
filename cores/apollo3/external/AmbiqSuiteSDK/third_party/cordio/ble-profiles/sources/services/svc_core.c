...
/* device name */
static uint8_t gapValDn[ATT_DEFAULT_PAYLOAD_LEN];
...
/* peripheral preferred connection parameter characteristic */
static const uint8_t gapValPpcpCh[] = {ATT_PROP_READ, UINT16_TO_BYTES(GAP_PPCP_HDL), UINT16_TO_BYTES(ATT_UUID_PREF_CONN_PARAM)};
static const uint16_t gapLenPpcpCh = sizeof(gapValPpcpCh);

/* peripheral preferred connection parameter */
static uint8_t gapValPpcp[ATT_DEFAULT_PAYLOAD_LEN];
...
{
  if(dev_name_len > ATT_DEFAULT_PAYLOAD_LEN)
    dev_name_len = ATT_DEFAULT_PAYLOAD_LEN;
...
/*************************************************************************************************/
/*!
 *  \brief  Set peripheral preferred connection parameter.
 *
 *  \return None.
 */
/*************************************************************************************************/
