# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c" 2
...
# 31 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c" 2
...
# 34 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c" 2
...
# 108 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
static void uiLcdProcessKey(uint8_t key)
{
  uiLcdProcessKeyTbl[UiCb.activeScreenType](key);
}
# 122 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
static void uiLcdProcessSplashKey(uint8_t key)
{
  switch(key)
  {
...
# 145 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
static void uiLcdProcessMenuKey(uint8_t key)
{
...
# 187 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
...
# 229 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
static void uiLcdProcessDialogAlphaNum(uint8_t key)
{
  ...
  case 10:
    if (offset < pDialog->entryMaxLen)
    {
      ...
      pDialog->pEntry[offset] = uiLcdAlphaNumNextChar(pDialog, 1);
    }
  ...
  case 11:
    if (offset < pDialog->entryMaxLen)
    {
      ...
      pDialog->pEntry[offset] = uiLcdAlphaNumNextChar(pDialog, 0);
    }
...
# 303 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
...
# 349 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
static void uiLcdProcessDialogKey(uint8_t key)
{
  UiDialog_t *pDialog = (UiDialog_t*) UiCb.pActiveScreen;
...
# 377 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
static void uiLcdScrollCallback(void)
{
  if (UiCb.activeScreenType == 1)
  {
    ...
    if (++uiLcdCb.scrollOffset > (int8_t) (strlen(pMenu->pItems[pMenu->highlight]) - (20 - 2)))
    {
      uiLcdCb.scrollOffset = 0;
    }
  ...
  else if (UiCb.activeScreenType == 2)
  {
    ...
    if (++uiLcdCb.scrollOffset > (int8_t) (strlen(pDialog->pSelectItems[pDialog->highlight]) - (20 - 2)))
    {
      uiLcdCb.scrollOffset = 0;
    }
...
# 414 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
static void uiLcdDispSplash(const UiSplashScreen_t *pSplash)
{
...
# 435 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
static void uiLcdDispTitle(const char *title)
{
  ...
  line[0] = '[';
  strncpy(line+1, title, 20 -2);
  strcat(line, "]");


  UiLcdWriteLine(0, line);
}
# 463 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
...
# 510 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
...
# 544 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
static void uiLcdDispMenu(const UiMenu_t *pMenu)
{
  ...
  appCalcFirstAndLastItem(&start, &end, 4 -1, pMenu->highlight, pMenu->numItems);
  ...
  for (i = start; i < end; i++)
  {
    ...
    strncpy(line+2, pMenu->pItems[i] + offset, 20 -2);
...
# 612 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
static void uiLcdDispDialogAlphaNum(const UiDialog_t *pDialog)
{
  ...
  strncpy(line + 2, pDialog->pEntry, 20 - 2);
  ...
  if (uiLcdCb.alphaNumOffset < pDialog->entryMaxLen)
  {
    ...
    cmdLine[uiLcdCb.alphaNumOffset + 2] = '^';
  }
  else
  {
...
# 661 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
static void uiLcdDispDialogSelect(const UiDialog_t *pDialog)
{
  ...
  appCalcFirstAndLastItem(&start, &end, 4 -2, pDialog->highlight, pDialog->numSelectItems);
  ...
  for (i = start; i < end; i++)
  {
    ...
    strncpy(line+2, pDialog->pSelectItems[i] + offset, 20 - 2);
    UiLcdWriteLine(pos++, line);
  }
...
# 713 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
static void uiLcdDispDialog(const UiDialog_t *pDialog)
{
...
# 741 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/ui_lcd.c"
void UiLcdInit(void)
{
  UiRegisterDisplay(uiLcdActionTbl, 1);
}
