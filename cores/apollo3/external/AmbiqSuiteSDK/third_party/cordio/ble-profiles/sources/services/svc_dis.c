# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/services/svc_dis.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/services/svc_dis.c"
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/services/svc_dis.c"
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/services/svc_dis.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/services/svc_dis.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/services/svc_dis.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/services/svc_dis.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/services/svc_dis.c" 2
...
# 31 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/services/svc_dis.c" 2
...
static const uint8_t disValSvc[] = {((uint8_t) (0x180A)), ((uint8_t)((0x180A) >> 8))};
static const uint16_t disLenSvc = sizeof(disValSvc);


static const uint8_t disValMfrCh[] = {0x02, ((uint8_t) (DIS_MFR_HDL)), ((uint8_t)((DIS_MFR_HDL) >> 8)), ((uint8_t) (0x2A29)), ((uint8_t)((0x2A29) >> 8))};
static const uint16_t disLenMfrCh = sizeof(disValMfrCh);


static const uint8_t disUuMfr[] = {((uint8_t) (0x2A29)), ((uint8_t)((0x2A29) >> 8))};
static uint8_t disValMfr[20] = "Arm Ltd.";
static uint16_t disLenMfr = 8;


static const uint8_t disValSidCh[] = {0x02, ((uint8_t) (DIS_SID_HDL)), ((uint8_t)((DIS_SID_HDL) >> 8)), ((uint8_t) (0x2A23)), ((uint8_t)((0x2A23) >> 8))};
static const uint16_t disLenSidCh = sizeof(disValSidCh);


static const uint8_t disUuSid[] = {((uint8_t) (0x2A23)), ((uint8_t)((0x2A23) >> 8))};
static uint8_t disValSid[8] = {0x01, 0x02, 0x03, 0x04, 0x05, ((uint8_t) (0x005F)), ((uint8_t) ((0x005F) >> 8)), 0x00};
static const uint16_t disLenSid = sizeof(disValSid);


static const uint8_t disValMnCh[] = {0x02, ((uint8_t) (DIS_MN_HDL)), ((uint8_t)((DIS_MN_HDL) >> 8)), ((uint8_t) (0x2A24)), ((uint8_t)((0x2A24) >> 8))};
static const uint16_t disLenMnCh = sizeof(disValMnCh);


static const uint8_t disUuMn[] = {((uint8_t) (0x2A24)), ((uint8_t)((0x2A24) >> 8))};
static uint8_t disValMn[20] = "Cordio model num";
static uint16_t disLenMn = 16;


static const uint8_t disValSnCh[] = {0x02, ((uint8_t) (DIS_SN_HDL)), ((uint8_t)((DIS_SN_HDL) >> 8)), ((uint8_t) (0x2A25)), ((uint8_t)((0x2A25) >> 8))};
static const uint16_t disLenSnCh = sizeof(disValSnCh);


static const uint8_t disUuSn[] = {((uint8_t) (0x2A25)), ((uint8_t)((0x2A25) >> 8))};
static uint8_t disValSn[20] = "Cordio serial num";
static uint16_t disLenSn = 17;


static const uint8_t disValFwrCh[] = {0x02, ((uint8_t) (DIS_FWR_HDL)), ((uint8_t)((DIS_FWR_HDL) >> 8)), ((uint8_t) (0x2A26)), ((uint8_t)((0x2A26) >> 8))};
static const uint16_t disLenFwrCh = sizeof(disValFwrCh);


static const uint8_t disUuFwr[] = {((uint8_t) (0x2A26)), ((uint8_t)((0x2A26) >> 8))};
static uint8_t disValFwr[16] = "Cordio fw rev";
static uint16_t disLenFwr = 13;


static const uint8_t disValHwrCh[] = {0x02, ((uint8_t) (DIS_HWR_HDL)), ((uint8_t)((DIS_HWR_HDL) >> 8)), ((uint8_t) (0x2A27)), ((uint8_t)((0x2A27) >> 8))};
static const uint16_t disLenHwrCh = sizeof(disValHwrCh);


static const uint8_t disUuHwr[] = {((uint8_t) (0x2A27)), ((uint8_t)((0x2A27) >> 8))};
static uint8_t disValHwr[16] = "Cordio hw rev";
static uint16_t disLenHwr = 13;


static const uint8_t disValSwrCh[] = {0x02, ((uint8_t) (DIS_SWR_HDL)), ((uint8_t)((DIS_SWR_HDL) >> 8)), ((uint8_t) (0x2A28)), ((uint8_t)((0x2A28) >> 8))};
static const uint16_t disLenSwrCh = sizeof(disValSwrCh);


static const uint8_t disUuSwr[] = {((uint8_t) (0x2A28)), ((uint8_t)((0x2A28) >> 8))};
static uint8_t disValSwr[16] = "Cordio sw rev";
static uint16_t disLenSwr = 13;


static const uint8_t disValRcdCh[] = {0x02, ((uint8_t) (DIS_RCD_HDL)), ((uint8_t)((DIS_RCD_HDL) >> 8)), ((uint8_t) (0x2A2A)), ((uint8_t)((0x2A2A) >> 8))};
static const uint16_t disLenRcdCh = sizeof(disValRcdCh);


static const uint8_t disUuRcd[] = {((uint8_t) (0x2A2A)), ((uint8_t)((0x2A2A) >> 8))};
static uint8_t disValRcd[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
# 316 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/services/svc_dis.c"
void SvcDisAddGroup(void)
{
  AttsAddGroup(&svcDisGroup);
}
# 328 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/services/svc_dis.c"
void SvcDisRemoveGroup(void)
{
  AttsRemoveGroup(0x0030);
}
