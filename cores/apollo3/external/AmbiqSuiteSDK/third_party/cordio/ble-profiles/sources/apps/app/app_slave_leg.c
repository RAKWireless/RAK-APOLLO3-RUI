# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c" 2
...
# 31 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c" 2
...
# 32 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c" 2
...
# 33 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c" 2
# 41 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
static void appSlaveLegAdvStart(void)
{
  ...
  interval = pAppAdvCfg->advInterval[appSlaveCb.advState[0]];
  ...
  if (interval > 0)
  {
    ...
    appAdvStart(1, &advHandle, &interval,
                &(pAppAdvCfg->advDuration[appSlaveCb.advState[0]]),
                &maxEaEvents, 1);
  }
  else
  {

    appSlaveCb.advState[0] = APP_ADV_STOPPED;
  }
}
# 75 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
static void appSlaveLegAdvTypeChanged(dmEvt_t *pMsg)
{

  appSlaveCb.advTypeChanged[0] = 0;


  appSlaveCb.advState[0] = APP_ADV_STATE1;


  appSlaveLegAdvStart();
}
# 96 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
static void appSlaveNextLegAdvState(dmEvt_t *pMsg)
{

  appSlaveCb.advState[0]++;


  if (appSlaveCb.advState[0] < APP_ADV_STOPPED)
  {
    appSlaveLegAdvStart();
  }
}
# 117 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
static void appSlaveLegAdvStop(dmEvt_t *pMsg)
{
  ...
  if (pMsg->hdr.event == DM_ADV_SET_STOP_IND)
  {
    ...
    if (pMsg->advSetStop.status == 0x00)
    {
  ...
  if (appSlaveCb.advTypeChanged[0])
  {
...
# 151 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
...
# 195 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
...
# 200 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c" 3 4
                                ((void *)0)
# 200 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
                                    )
  {
...
# 229 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
void AppAdvSetData(uint8_t location, uint8_t len, uint8_t *pData)
{
  if (appSlaveAdvMode())
  {
    ...
    appAdvSetData(0, location, len, pData, 31, 31);
  }
}
# 253 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
void AppAdvStart(uint8_t mode)
{
  uint8_t advHandle;
  uint8_t maxEaEvents;
  ...
  if (appSlaveAdvMode())
  {
    ...
    appSlaveAdvStart(1, &advHandle, &(pAppAdvCfg->advInterval[APP_ADV_STATE1]),
                     &(pAppAdvCfg->advDuration[APP_ADV_STATE1]), &maxEaEvents, 1, mode);
  }
}
# 278 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
void AppAdvStop(void)
{
  uint8_t advHandle;
...
# 309 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
bool_t AppAdvSetAdValue(uint8_t location, uint8_t adType, uint8_t len, uint8_t *pValue)
{
  if (appSlaveAdvMode())
  {
    return appAdvSetAdValue(0, location, adType, len, pValue);
  }

  return 0;
}
# 328 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
void AppSetAdvType(uint8_t advType)
{
  if (appSlaveAdvMode())
  {
    ...
    appSlaveCb.advState[0] = APP_ADV_STATE1;
    appSetAdvType(0, advType,
                  pAppAdvCfg->advInterval[appSlaveCb.advState[0]],
                  pAppAdvCfg->advDuration[appSlaveCb.advState[0]], 0, 1);
  }
}
# 350 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
void AppSetAdvPeerAddr(uint8_t peerAddrType, uint8_t *pPeerAddr)
{
  appSlaveCb.peerAddrType[0] = peerAddrType;
  BdaCpy(appSlaveCb.peerAddr[0], pPeerAddr);
}
# 368 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_slave_leg.c"
dmConnId_t AppConnAccept(uint8_t advType, uint8_t addrType, uint8_t *pAddr, appDbHdl_t dbHdl)
{
  dmConnId_t connId;
  ...
  if (appSlaveAdvMode())
  {
    ...
    connId = appConnAccept(0, advType, pAppAdvCfg->advInterval[APP_ADV_STATE1],
                           pAppAdvCfg->advDuration[APP_ADV_STATE1], 0, addrType, pAddr, dbHdl,
                           0);
    if (connId != 0)
    {
      appSlaveCb.advDirected = 1;
    }
  }
  else
  {
