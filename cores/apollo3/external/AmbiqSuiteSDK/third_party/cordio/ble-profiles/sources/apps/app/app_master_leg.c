# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_leg.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_leg.c"
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_leg.c"
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_leg.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_leg.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_leg.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_leg.c" 2
...
# 31 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_leg.c" 2
# 39 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_leg.c"
static bool_t appMasterScanMode(void)
{
  ...
  if (appMasterCb.scanMode == 255)
  {
    ...
    appMasterCb.scanMode = 0;

    return 1;
  }

  if (appMasterCb.scanMode == 0)
  {
    return 1;
  }
...
# 75 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_leg.c"
void AppScanStart(uint8_t mode, uint8_t scanType, uint16_t duration)
{
  if (appMasterScanMode())
  {
    DmScanSetInterval((1<<0), &pAppMasterCfg->scanInterval, &pAppMasterCfg->scanWindow);

    DmScanStart((1<<0), mode, &scanType, 1, duration, 0);
  }
}
# 92 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_leg.c"
void AppScanStop(void)
{
  if (appMasterScanMode())
  {
...
# 114 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_leg.c"
dmConnId_t AppConnOpen(uint8_t addrType, uint8_t *pAddr, appDbHdl_t dbHdl)
{
  if (appMasterScanMode())
  {
    return appConnOpen((1<<0), addrType, pAddr, dbHdl);
  }
