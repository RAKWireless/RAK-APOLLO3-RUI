# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c"
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c"
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c" 2
...
# 31 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c" 2
...
# 32 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c" 2
...
#define APP_NUM_BPM 3
#define APP_NUM_INT_BPM 3
...
static const appHwSimBpm_t appHwBpm[3] =
{
  {
    ((140) | ((int16_t)(0) << 12)),
    ((80) | ((int16_t)(0) << 12)),
...
static const appHwSimBpm_t appHwIntBpm[3] =
{
  {
    ((103) | ((int16_t)(0) << 12)),
    0x07FF,
...
static const uint16_t appHwWeightLbs[3] =
{
  15010,
  15120,
  15230
...
static const uint16_t appHwWeightKg[3] =
{
  6823,
  6873,
  6923
...
static const uint32_t appHwTempC[6] =
{
  ((369) | ((int32_t)(-1) << 24)),
  ((370) | ((int32_t)(-1) << 24)),
  ((371) | ((int32_t)(-1) << 24)),
...
static const uint32_t appHwTempF[6] =
{
  ((985) | ((int32_t)(-1) << 24)),
  ((986) | ((int32_t)(-1) << 24)),
  ((987) | ((int32_t)(-1) << 24)),
...
static uint8_t appHwTmUnits = 0x00;


static uint8_t appHwWmUnits = 0x01;
...
# 238 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c"
void AppHwBattRead(uint8_t *pLevel)
{
 *pLevel = appHwBattLevel;
}
# 252 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c"
void AppHwBattTest(uint8_t level)
{
  appHwBattLevel = level;
}
# 267 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c"
void AppHwHrmRead(appHrm_t *pHrm)
{
  pHrm->heartRate = appHwHeartRate;


  appHwRrInterval[0] = (((uint16_t) 1024 * 60) / (appHwHeartRate));
  appHwRrInterval[1] = (((uint16_t) 1024 * 60) / (appHwHeartRate));

  pHrm->pRrInterval = appHwRrInterval;
  pHrm->numIntervals = 2;
}
# 288 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c"
void AppHwHrmTest(uint8_t heartRate)
{
  appHwHeartRate = heartRate;
}
# 303 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c"
void AppHwBpmRead(bool_t intermed, appBpm_t *pBpm)
{
  appHwSimBpm_t *pMeas;
...
# 356 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c"
void AppHwWsmRead(appWsm_t *pWsm)
{


  if (appHwWmUnits == 0x01)
  {
...
# 396 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c"
void AppHwTmRead(bool_t intermed, appTm_t *pTm)
{

  if (appHwTmUnits == 0x00)
  {
...
# 437 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c"
void AppHwTmSetUnits(uint8_t units)
{
  appHwTmUnits = units;
}
# 452 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c"
void AppHwWmSetUnits(uint8_t units)
{
  appHwWmUnits = units;
}
# 466 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c"
void AppHwPlxcmRead(appPlxCm_t *pPlxcm)
{
  memcpy(pPlxcm, &appHwPlxCm, sizeof(appPlxCm_t));
}
# 480 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/common/app_hw.c"
void AppHwPlxscmRead(appPlxScm_t *pPlxscm)
{
