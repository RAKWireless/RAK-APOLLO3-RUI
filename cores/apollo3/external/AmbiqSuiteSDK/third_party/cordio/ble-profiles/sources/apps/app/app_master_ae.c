# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_ae.c"
...
#define SUPPORT_AT 1
# 1 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_ae.c"
# 25 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_ae.c"
...
# 26 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_ae.c" 2
...
# 27 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_ae.c" 2
...
# 28 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_ae.c" 2
...
# 29 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_ae.c" 2
...
# 30 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_ae.c" 2
# 38 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_ae.c"
static bool_t appMasterExtScanMode(void)
{
  ...
  if (DmScanModeExt())
  {
    ...
    if (appMasterCb.scanMode == 255)
    {

      appMasterCb.scanMode = 1;

      return 1;
    }
  }

  if (appMasterCb.scanMode == 1)
  {
    return 1;
  }
...
# 79 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_ae.c"
void AppExtScanStart(uint8_t scanPhys, uint8_t mode, const uint8_t *pScanType, uint16_t duration,
                     uint16_t period)
{
  uint8_t i;
  ...
  if (appMasterExtScanMode())
  {
    ...
    DmScanStart(scanPhys, mode, scanType, 1, duration, period);
  }
}
# 114 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_ae.c"
void AppExtScanStop(void)
{
  if (appMasterExtScanMode())
  {
...
# 140 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_ae.c"
dmSyncId_t AppSyncStart(uint8_t advSid, uint8_t advAddrType, const uint8_t *pAdvAddr, uint16_t skip,
                        uint16_t syncTimeout)
{
  if (appMasterExtScanMode())
...
# 161 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_ae.c"
void AppSyncStop(dmSyncId_t syncId)
{
  if (appMasterExtScanMode())
  {
...
# 181 "/home/jenkins/workspace/RUI_Release/rui-v3/external/AmbiqSuiteSDK/third_party/cordio/ble-profiles/sources/apps/app/app_master_ae.c"
dmConnId_t AppExtConnOpen(uint8_t initPhys, uint8_t addrType, uint8_t *pAddr, appDbHdl_t dbHdl)
{
  if (appMasterExtScanMode())
  {
